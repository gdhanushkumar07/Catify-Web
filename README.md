...
> _Ready-to-use copy-paste description for your hackathon submission:_
...
> _Ready-to-use comma-separated list of technologies used:_
...
_Note: For the icons, the dynamic zip generator inside the sandbox compile and write the physical launcher icons (`cat_16.png`, `cat_48.png`, `cat_128.png`) on-the-fly. They are completely loaded and mapped inside the extension's folder structures._
...
3. **Enable Developer Mode**:
   ...
   - Switch the toggle to **ON**. A new sub-header with options like _"Load unpacked"_, _"Pack extension"_, and _"Update"_ will appear on the upper left.
